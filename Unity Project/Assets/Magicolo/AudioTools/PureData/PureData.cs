...
// TODO Option to link sequences together in the editor.
// TODO Mute and Solo options on buses
// TODO Find a way to retreive the actual settings for settings that can be delayed or ramped (volume, pitch, etc.). Will need to be retreived from Pure Data.
// TODO More commands for [s Command] ?
// TODO Give access to spatializer settings
// TODO Complete documentation (XML, Tooltips, Help patches)
// TODO Autoduck on buses (one bus autoducks another one)
// FIXME Remove the clicks when using PureDataOption.PlayRange or the PureDataOption.Time
// FIXME Doppler bug when pausing and playing the editor
...
// TODO Divide sound into multiple parts (play by calling soundName + suffix) instead of just one play range.
// TODO Obstacle filtering and HRTF (head related transfer function)
// TODO Support more than 2 channels
// TODO Support streaming sounds
// TODO Support objects from Pure Data Extended (implies to recompile libpdcsharp.dll and may require to modify the LibPD scripts)
